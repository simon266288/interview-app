<template>
  <div class="h-full flex flex-col bg-gray-50" data-testid="home.page">
    ...
    <div class="flex-1 p-4 overflow-y-auto">
      <div class="mb-4">
        <button @click="shuffleBatch" class="w-full bg-white p-3 rounded-xl shadow-sm hover:shadow-md transition active:scale-95 flex items-center justify-center" data-testid="home.shuffle">
          <i class="fas fa-random mr-2 text-blue-600"></i>
          <span class="font-bold text-gray-800">换一批</span>
        </button>
      </div>
